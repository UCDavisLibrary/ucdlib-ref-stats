...
import {render, styles} from "./ref-stats-page-dashboard-admin.tpl.js";
...
/**
 * @description Admin page element that lists all dashboards with label search and form filter.
 ...
 */
export default class RefStatsPageDashboardAdmin extends Mixin(LitElement)
   ...
   */
  async query() {
    const res = await this.DashboardModel.query(this.ctl.qs.query);
    if ( res.state !== 'loaded' ) {
      this.dashboards = [];
      this.maxPage = 1;
      return;
...
customElements.define('ref-stats-page-dashboard-admin', RefStatsPageDashboardAdmin);
